        ...
        >
            <div className="container-custom flex items-center">
                ...
                <div className="flex-1">
                    <Link to="/" className="text-2xl font-serif font-bold tracking-tight text-white inline-block">
                        Cozy Cover
                    </Link>
                </div>
                ...
                {/* Icons and Switcher - Right */}
                <div className="flex-1 flex items-center justify-end gap-4">
                    <div className="hidden sm:block mr-2 border-r border-primary-700 pr-2">
                        <LanguageSwitcher />
                    </div>
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <div className="p-4 border-b border-primary-800 flex justify-between items-center">
                            <span className="text-xs font-bold uppercase tracking-widest text-primary-300">Language</span>
                            <LanguageSwitcher />
                        </div>
